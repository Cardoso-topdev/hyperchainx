    ...
    <div className='bg-dark p-[30px] max-md:p-[20px]'>
      <div className='flex items-start'>
        ...
        <div className='ml-[30px] w-full max-3xl:flex max-3xl:justify-between max-md:block'>
          <div>
            <h3 className={`text-[24px] leading-broad uppercase tracking-minor-wide max-md:tracking-normal max-md:text-[20px] ${member.name.length>11 ? 'max-md:leading-super-tight': 'max-md:leading-tight'}`}>
              {member.name}
            </h3>
...
export const TeamSection: React.FC<{ members: Array<IMember> }> = ({
  ...
  return (
    <section className='max-w-[1200px] mx-auto max-3xl:px-[30px]'>
      <h1 className='mt-[100px] mb-[50px] text-center text-[30px] tracking-wide leading-none max-3xl:mt-[75px] max-md:mt-[50px] max-md:mb-[30px]'>THE TEAM</h1>
