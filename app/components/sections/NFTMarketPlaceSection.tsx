...
const NFTMarketPlaceSection = () => {
  return (
    <section className="mt-[150px] max-xmd:mt-[75px]">
      ...
      <div className="max-w-[1200px] m-auto relative pt-[100px] px-[30px]">
        ...
        <div className="flex mt-[30px] max-xmd:flex-col">
          ...
          <div className="bg-[rgba(22,22,22,0.7)] w-full backdrop-blur-[20px] p-[50px] max-lg:p-[20px]">
            ...
            <div className="text-light-grey mt-[30px] max-lg:text-[14px] max-lg:mt-[20px] font-['Industry']">
              With a focus on culture, history, and future trends, we provide a
              fully dedicated platform with custom mystery boxes, whitelisting
              options, free claims, NFT contract creation support, and an
              affiliate marketing program to boost sales. Our launchpad is
              designed to give creators all the opportunities for a successful
              launch. Join us now and unlock the full potential of your NFT
              collection in the thriving crypto gaming industry.
            </div>
          </div>
        </div>
