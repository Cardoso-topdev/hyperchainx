    ...
    <section className='bg-[#111] py-[100px]'>
      <div className="max-w-[1200px] m-auto">
        <div className="flex gap-[65px] items-center">
          ...
          />
          <div className="100px">
            <div className="text-[30px] font-bold mb-[10px]">HYPERTRONS NFTS</div>
            <div className="text-electric-lime text-[20px] mb-[30px]">Own NFTs that offer profit-sharing!</div>
