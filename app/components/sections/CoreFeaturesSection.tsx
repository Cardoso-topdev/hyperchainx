      ...
      <div className="max-w-[1200px] m-auto">
        ...
        <div className="flex gap-[40px]">
          <div className="bg-dark w-[270px] h-[384px] flex flex-col items-center p-[20px] pt-[30px]">
            ...
            />
            <div className="text-white uppercase text-[24px] font-bold mt-[20px]">NFTs</div>
          ...
          <div className="bg-dark w-[270px] h-[384px] flex flex-col items-center p-[20px] pt-[30px]">
            <Image
              ...
              style={{ objectFit: "contain" }}
            />
            <div className="text-white uppercase text-[24px] font-bold mt-[20px]">PLAY TO EARN</div>
          ...
          <div className="bg-dark w-[270px] h-[384px] flex flex-col items-center p-[20px] pt-[30px]">
            <Image
              ...
              style={{ objectFit: "contain" }}
            />
            <div className="text-white uppercase text-[24px] font-bold mt-[26px]">GAME STORE</div>
          ...
          <div className="bg-dark w-[270px] h-[384px] flex flex-col items-center p-[20px] pt-[30px]">
            <Image
              ...
              style={{ objectFit: "contain" }}
            />
            <div className="text-white uppercase text-[24px] font-bold mt-[26px]">LIVE STREAMS</div>
